...
// my custom layout that mostly just flips cmd and shift
#elif defined MIRYOKU_ALPHAS_COLLICUN
  [BASE] = LAYOUT_miryoku(
    KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_SCLN,
    LSFT_T(KC_A),      LALT_T(KC_R),      LCTL_T(KC_S),      LGUI_T(KC_T),      KC_G,              KC_M,              LGUI_T(KC_N),      LCTL_T(KC_E),      LALT_T(KC_I),      LSFT_T(KC_O),
    KC_Z,              ALGR_T(KC_X),      KC_C,              KC_D,              KC_V,              KC_K,              KC_H,              KC_COMM,           ALGR_T(KC_DOT),    KC_SLSH,
    X_NP,              X_NP,              LT(MEDR, KC_TAB),  LT(NAVR, KC_SPC),  LT(MOUR, KC_BSPC),  LT(NSSL, KC_BSPC),  LT(NSL, KC_UNDS),  LT(FUNL, KC_DEL),  X_NP,              X_NP
  ),
#else
  [BASE] = LAYOUT_miryoku(
    KC_Q,              KC_W,              KC_F,              KC_P,              KC_B,              KC_J,              KC_L,              KC_U,              KC_Y,              KC_QUOT,
  ...
  [NAVR] = LAYOUT_miryoku(
    RESET,   X_NA,    X_NA,    X_NA,    X_NA,    KC_AGIN, KC_UNDO, KC_CUT,  KC_COPY, KC_PSTE,
    KC_LSFT, KC_LALT, KC_LCTL, KC_LGUI, X_NA,    KC_CAPS, KC_LEFT, KC_DOWN, KC_UP,   KC_RGHT,
    X_NA,    KC_ALGR, X_NA,    X_NA,    X_NA,    KC_INS,  KC_HOME, KC_PGDN, KC_PGUP, KC_END,
    X_NP,    X_NP,    X_NA,    X_NA,    X_NA,    KC_ENT,  KC_BSPC, KC_DEL,  X_NP,    X_NP
  ),
  [MOUR] = LAYOUT_miryoku(
    RESET,   X_NA,    X_NA,    X_NA,    X_NA,    X_NU,    X_NU,    X_NU,    X_NU,    X_NU,
    KC_LSFT, KC_LALT, KC_LCTL, KC_LGUI, X_NA,    X_NU,    KC_MS_L, KC_MS_D, KC_MS_U, KC_MS_R,
    X_NA,    KC_ALGR, X_NA,    X_NA,    X_NA,    X_NU,    KC_WH_L, KC_WH_D, KC_WH_U, KC_WH_R,
    X_NP,    X_NP,    X_NA,    X_NA,    X_NA,    KC_BTN1, KC_BTN3, KC_BTN2, X_NP,    X_NP
  ),
  [MEDR] = LAYOUT_miryoku(
    RESET,   X_NA,    X_NA,    X_NA,    X_NA,    RGB_TOG, RGB_MOD, RGB_HUI, RGB_SAI, RGB_VAI,
    KC_LSFT, KC_LALT, KC_LCTL, KC_LGUI, X_NA,    X_NU,    KC_MPRV, KC_VOLD, KC_VOLU, KC_MNXT,
    X_NA,    KC_ALGR, X_NA,    X_NA,    X_NA,    X_NU,    X_NU,    X_NU,    X_NU,    X_NU,
    X_NP,    X_NP,    X_NA,    X_NA,    X_NA,    KC_MSTP, KC_MPLY, KC_MUTE, X_NP,    X_NP
  ),
#endif /*
  ...
  [FUNL] = LAYOUT_miryoku(
    KC_F12,  KC_F7,   KC_F8,   KC_F9,   KC_PSCR, X_NA,    X_NA,    X_NA,    X_NA,    RESET,
    KC_F11,  KC_F4,   KC_F5,   KC_F6,   KC_SLCK, X_NA,    KC_LGUI, KC_LCTL, KC_LALT, KC_LSFT,
    KC_F10,  KC_F1,   KC_F2,   KC_F3,   KC_PAUS, X_NA,    X_NA,    X_NA,    KC_ALGR, X_NA,
    X_NP,    X_NP,    KC_APP,  KC_SPC,  KC_TAB,  X_NA,    X_NA,    X_NA,    X_NP,    X_NP
  ),
  [NSL] = LAYOUT_miryoku(
    KC_LBRC, KC_7,    KC_8,    KC_9,    KC_RBRC, X_NA,    X_NA,    X_NA,    X_NA,    RESET,
    KC_SCLN, KC_4,    KC_5,    KC_6,    KC_EQL,  X_NA,    KC_LGUI, KC_LCTL, KC_LALT, KC_LSFT,
    KC_GRV,  KC_1,    KC_2,    KC_3,    KC_BSLS, X_NA,    X_NA,    X_NA,    KC_ALGR, X_NA,
    X_NP,    X_NP,    KC_DOT,  KC_0,    KC_MINS, X_NA,    X_NA,    X_NA,    X_NP,    X_NP
  ),
  [NSSL] = LAYOUT_miryoku(
    KC_LCBR, KC_AMPR, KC_ASTR, KC_LPRN, KC_RCBR, X_NA,    X_NA,    X_NA,    X_NA,    RESET,
    KC_COLN, KC_DLR,  KC_PERC, KC_CIRC, KC_PLUS, X_NA,    KC_LGUI, KC_LCTL, KC_LALT, KC_LSFT,
    KC_TILD, KC_EXLM, KC_AT,   KC_HASH, KC_PIPE, X_NA,    X_NA,    X_NA,    KC_ALGR, X_NA,
    X_NP,    X_NP,    KC_LPRN, KC_RPRN, KC_UNDS, X_NA,    X_NA,    X_NA,    X_NP,    X_NP
  )
};
